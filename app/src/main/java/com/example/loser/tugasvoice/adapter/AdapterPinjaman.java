...
import com.example.loser.tugasvoice.DetailBarangPinjman;
...
public class AdapterPinjaman extends RecyclerView.Adapter<AdapterPinjaman.ViewHolder> implements View.OnClickListener {
    ...
    public AdapterPinjaman(Context context, List<Barang> barangList) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tvStatus.setText("IDENTITAS : "+penulis);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, DetailBarangPinjman.class);
